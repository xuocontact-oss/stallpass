...
export default async function ShopperSetupPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-lg space-y-5 px-4 py-8">
      <div>
        <h1 className="text-2xl font-bold">Find markets near you</h1>
        <p className="text-muted-foreground">Two quick questions and you&apos;re in.</p>
      </div>
      <ActionForm action={saveShopperProfile} className="space-y-4 rounded-xl border bg-background p-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">Reviews show your first name and last initial, like &ldquo;Maria G.&rdquo;</p>
        </div>
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-muted-foreground">So we can show markets near you first. You can change it any time.</p>
        </div>
