...
const baseButtonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border-2 bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "border-ink bg-primary text-primary-foreground poster-shadow-sm hover:-translate-y-px hover:poster-shadow hover:bg-primary active:translate-x-px active:translate-y-px active:shadow-none",
        outline:
          "border-ink bg-background hover:bg-secondary hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
        ...
        ghost:
          "border-transparent hover:bg-ink/5 hover:text-foreground aria-expanded:bg-muted aria-expanded:text-foreground dark:hover:bg-muted/50",
        destructive:
...
/** Button classes, merged so a passed className (e.g. "hidden sm:inline-flex") wins over the defaults. */
const buttonVariants = (props?: Parameters<typeof baseButtonVariants>[0]) => cn(baseButtonVariants(props))
